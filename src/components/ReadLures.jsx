...
import { predatorFish, peacefulFish } from '../constants/lures.js';
import Icons from './Icons.jsx'

const { width, height } = Dimensions.get("window");

const ReadLures = ({ type }) => {
    const navigation = useNavigation();
    const fishData = type === "predator" ? predatorFish : peacefulFish;
    ...
    return (
        <LinearGradient colors={["#0470ec", "#012355"]} style={{width: '100%', height: '100%'}}>
            ...
            <Text style={styles.title}>{fishData[currentIndex]?.name}</Text>
